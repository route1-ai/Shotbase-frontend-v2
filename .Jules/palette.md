...
## 2025-05-15 - [Snap-to-View and Orbital Accessibility]
...
**Action:** Use `button` elements for orbital nodes with `onFocus` handlers for content expansion and `onClick` for view rotation to ensure full keyboard and screen reader accessibility while maintaining visual delight.
