      ...
      {showCreate && (
        <div style={{ ...cardStyle, marginBottom: 18, border: `1px solid ${ACTIVE_BORDER}` }}>
          ...
          <div style={{ marginBottom: 18 }}>
            <label htmlFor="endpoint-url" style={{ display: "block", fontFamily: "var(--font-ibm-plex)", fontSize: 10, color: "#666", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 6 }}>
              Endpoint URL
            </label>
            <input
              id="endpoint-url"
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 8 }} aria-live="polite">
                    {confirmingDeleteId === ep.id && (
                      <button
                        ...
                        style={{ fontFamily: "var(--font-ibm-plex)", fontSize: 11, color: "#888", background: "transparent", border: `1px solid ${BORDER}`, padding: "5px 10px", borderRadius: 6, cursor: "pointer" }}
                      >
                        Cancel
                      </button>
                    )}
                    <button
                      ...
                      aria-label={confirmingDeleteId === ep.id ? `Confirm delete webhook endpoint ${ep.url}` : `Delete webhook endpoint ${ep.url}`}
                      style={{
                        fontFamily: "var(--font-ibm-plex)",
                        fontSize: 11,
                        color: confirmingDeleteId === ep.id ? "#ffffff" : "#ff6060",
                        background: confirmingDeleteId === ep.id ? "rgba(255,60,60,0.85)" : "transparent",
                        border: "1px solid rgba(255,60,60,0.2)",
                        padding: "5px 12px",
                        borderRadius: 6,
                        cursor: "pointer",
                        fontWeight: confirmingDeleteId === ep.id ? 600 : 400,
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
                    ...
                    <div style={{ display: "flex", gap: 12 }}>
                      <button
                        ...
                        aria-expanded={Boolean(revealed[ep.id])}
