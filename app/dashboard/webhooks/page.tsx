                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 14 }}>
                  ...
                  <div aria-live="polite">
                    <button
                      ...
                      aria-label={confirmDeleteId === ep.id ? "Confirm delete endpoint" : "Delete endpoint"}
                      style={{
                        fontFamily: "var(--font-ibm-plex)",
                        fontSize: 11,
                        color: confirmDeleteId === ep.id ? "#ffffff" : "#ff6060",
                        background: confirmDeleteId === ep.id ? "#dc2626" : "transparent",
                        border: `1px solid ${confirmDeleteId === ep.id ? "#dc2626" : "rgba(255,60,60,0.2)"}`,
                        padding: "5px 12px",
                        borderRadius: 6,
                        cursor: "pointer",
                        transition: "all 0.15s",
