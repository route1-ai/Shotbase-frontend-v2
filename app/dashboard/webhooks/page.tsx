...
const VERIFY_CODE_SNIPPET = `// Every delivery includes a 'Shotbase-Signature' header.
// Verify in Node:
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 14 }}>
                  ...
                  <div aria-live="polite">
                    <button
                      ...
                      aria-label={confirmingDeleteId === ep.id ? `Confirm deletion of endpoint ${ep.url}` : `Delete endpoint ${ep.url}`}
                      style={{
                        fontFamily: "var(--font-ibm-plex)",
                        fontSize: 11,
                        color: confirmingDeleteId === ep.id ? "#ff4d4d" : "#ff6060",
                        background: confirmingDeleteId === ep.id ? "rgba(255,60,60,0.15)" : "transparent",
                        border: confirmingDeleteId === ep.id ? "1px solid rgba(255,60,60,0.4)" : "1px solid rgba(255,60,60,0.2)",
                        padding: "5px 12px",
                        borderRadius: 6,
                        cursor: "pointer",
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              <div aria-live="polite">
                <button
                  type="button"
                  onClick={() => copy("snippet", VERIFY_CODE_SNIPPET)}
                  style={{
                    fontFamily: "var(--font-ibm-plex)",
                    fontSize: 11,
                    color: copied === "snippet" ? "#00e87b" : "#888",
                    background: "transparent",
                    border: `1px solid ${copied === "snippet" ? ACTIVE_BORDER : BORDER}`,
                    padding: "4px 10px",
                    borderRadius: 5,
                    cursor: "pointer",
                    transition: "all 0.15s ease",
