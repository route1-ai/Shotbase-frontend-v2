                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 14 }}>
                  ...
                  <div aria-live="polite">
                    <button
                      ...
                      aria-label={confirmDeleteId === ep.id ? "Confirm deletion of webhook endpoint" : "Delete webhook endpoint"}
                      style={{
                        fontFamily: "var(--font-ibm-plex)",
                        fontSize: 11,
                        color: confirmDeleteId === ep.id ? "#fff" : "#ff6060",
                        background: confirmDeleteId === ep.id ? "#dc2626" : "transparent",
                        border: confirmDeleteId === ep.id ? "1px solid #ef4444" : "1px solid rgba(255,60,60,0.2)",
                        padding: "5px 12px",
                        borderRadius: 6,
                        cursor: "pointer",
