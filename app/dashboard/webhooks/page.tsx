              ...
              <div key={ep.id} style={cardStyle}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 14 }}>
                  ...
                  <button
                    ...
                    aria-label={deleteConfirmId === ep.id ? `Confirm deletion of endpoint ${ep.url}` : `Delete endpoint ${ep.url}`}
                    style={{
                      fontFamily: "var(--font-ibm-plex)",
                      fontSize: 11,
                      color: deleteConfirmId === ep.id ? "#fff" : "#ff6060",
                      background: deleteConfirmId === ep.id ? "rgba(255,60,60,0.8)" : "transparent",
                      border: `1px solid ${deleteConfirmId === ep.id ? "#ff6060" : "rgba(255,60,60,0.2)"}`,
                      padding: "5px 12px",
                      borderRadius: 6,
                      cursor: "pointer",
