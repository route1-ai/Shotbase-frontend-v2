      ...
      <div style={{ ...cardStyle, marginTop: 20 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <button
              type="button"
              onClick={() => copy("verify_code", VERIFY_SNIPPET)}
              aria-label="Copy signature verification snippet to clipboard"
              style={{ fontFamily: "var(--font-ibm-plex)", fontSize: 11, color: copied === "verify_code" ? "#00e87b" : "#888", background: "transparent", border: "none", cursor: "pointer", padding: 0 }}
            >
              {copied === "verify_code" ? "✓ Copied" : "Copy code"}
            </button>
