                ...
                <tbody>
                  {filtered.map((r, i) => (
                    <tr
                      ...
                      tabIndex={0}
                      role="row"
                      aria-label={`Log request ${r.id || i + 1} for ${r.url || "unknown url"}`}
                      ...
                      className="focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[#00e87b] focus-visible:bg-[rgba(0,232,123,0.05)]"
