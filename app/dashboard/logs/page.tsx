      ...
      >
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
              ...
              <div aria-live="polite">
                <button
                  ...
                  aria-label="Copy request payload JSON"
                  style={{ fontFamily: "var(--font-ibm-plex)", fontSize: 10, color: copied === "req" ? "#00e87b" : "#888", background: "transparent", border: "none", cursor: "pointer", padding: 0 }}
                >
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
              ...
              <div aria-live="polite">
                <button
                  ...
                  style={{ fontFamily: "var(--font-ibm-plex)", fontSize: 10, color: copied === "res" ? "#00e87b" : "#888", background: "transparent", border: "none", cursor: "pointer", padding: 0 }}
                >
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
              ...
              <div aria-live="polite">
                <button
                  ...
                  style={{ fontFamily: "var(--font-ibm-plex)", fontSize: 10, color: copied === "curl" ? "#00e87b" : "#888", background: "transparent", border: "none", cursor: "pointer", padding: 0 }}
                >
        ...
        <div style={{ display: "flex", gap: 8, padding: "14px 22px", borderTop: `1px solid ${BORDER}`, flexShrink: 0 }}>
          <button
            type="button"
            onClick={() => copy("curl", curlCmd)}
            aria-label="Replay request by copying cURL command"
                ...
                <tbody>
                  {filtered.map((r, i) => (
                    <tr
                      key={r.id || i}
                      tabIndex={0}
                      aria-label={`View request details for ${r.id || `row ${i + 1}`}`}
                      ...
                      onFocus={(e) => (e.currentTarget.style.background = "rgba(0,232,123,0.06)")}
