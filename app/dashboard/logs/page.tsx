                ...
                <tbody>
                  {filtered.map((r, i) => (
                    <tr
                      ...
                      tabIndex={0}
                      role="row"
                      aria-label={`View details for request ${r.id || r.url || i}`}
                      ...
                      className="hover:bg-white/[0.02] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[#00e87b] focus-visible:ring-inset"
