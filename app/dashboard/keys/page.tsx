                      ...
                      {k.key && (
                        <div aria-live="polite" style={{ display: "inline-flex", alignItems: "center" }}>
                          <button
                            ...
                            aria-label={copiedId === k.id ? "Key copied" : "Copy API key to clipboard"}
                            style={{ background: "none", border: "none", cursor: "pointer", padding: 0, display: "flex", alignItems: "center", color: copiedId === k.id ? "#00e87b" : "#888", transition: "color 0.15s ease" }}
                          >
