                      ...
                      <div aria-live="polite" style={{ display: "inline-flex" }}>
                        {k.key && (
                          <button
                            ...
                            style={{ fontFamily: "var(--font-ibm-plex)", fontSize: 10, color: copiedId === k.id ? "#00e87b" : "#888", background: "none", border: "none", cursor: "pointer", padding: 0, marginLeft: 8, fontWeight: copiedId === k.id ? 600 : 400 }}
                          >
