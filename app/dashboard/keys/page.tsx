...
export default function KeysPage() {
  const [keys, setKeys] = useState<{ id: string; name: string; key?: string; createdAt?: number; active?: boolean; last?: string; requests?: number }[]>([])
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 8 }} aria-live="polite">
                      ...
                      {revealed[k.id] && k.key && (
                        <button
                          ...
                          aria-label={copiedId === k.id ? "Key copied" : "Copy key to clipboard"}
                          style={{ fontFamily: "var(--font-ibm-plex)", fontSize: 10, color: copiedId === k.id ? "#00e87b" : "#888", background: "none", border: "none", cursor: "pointer", padding: "0 4px", fontWeight: copiedId === k.id ? 600 : 400 }}
                        >
