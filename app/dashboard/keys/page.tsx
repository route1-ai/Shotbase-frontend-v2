                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                      ...
                      <button
                        ...
                        onClick={() => setRevealed((r) => {
                          const isShowing = !r[k.id];
                          if (!isShowing) {
                            // If hiding, also clear copiedId if this item was the one copied
                            setCopiedId((prev) => prev === k.id ? null : prev);
                          }
                          return { ...r, [k.id]: isShowing };
                        })}
                        ...
                        <div style={{ display: "inline-flex", alignItems: "center" }} aria-live="polite">
                          <button
                            ...
                            style={{
                              ...
                              borderWidth: 1,
                              borderStyle: "solid",
                              borderColor: copiedId === k.id ? "rgba(0,232,123,0.3)" : "rgba(255,255,255,0.1)",
