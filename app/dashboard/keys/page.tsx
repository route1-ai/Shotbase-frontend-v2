...
export default function KeysPage() {
  ...
  const toggleReveal = (id: string) => {
    const nextVal = !revealed[id]
    setRevealed((r) => ({ ...r, [id]: nextVal }))
    if (!nextVal && copiedId === id) {
      setCopiedId(null)
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                      ...
                      {revealed[k.id] && k.key && (
                        <button
                          ...
                          className="ccopy"
                          style={{ background: "none", border: "none", cursor: "pointer", padding: "4px 8px", marginRight: 0, color: copiedId === k.id ? "#00e87b" : "#888" }}
