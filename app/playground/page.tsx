...
export default function Playground() {
  ...
  useEffect(() => {
    ...
    if (copiedCode) {
      timer = setTimeout(() => setCopiedCode(false), 2000)
    }
    return () => {
          ...
          <div style={{ flexShrink: 0, borderTop: '1px solid rgba(255,255,255,0.07)', background: '#0a0a0a' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: '1px solid rgba(255,255,255,0.07)', padding: '0 16px' }}>
              ...
              <button
                ...
                style={{ fontFamily: 'var(--font-ibm-plex)', fontSize: 11, color: copiedCode ? '#00e87b' : '#444', background: 'none', border: 'none', cursor: 'pointer', padding: '6px 8px', display: 'flex', alignItems: 'center', gap: 4, transition: 'color 0.15s' }}
              >
