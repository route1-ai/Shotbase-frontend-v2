...
export default function Playground() {
  ...
  const [result, setResult] = useState<{
    screenshotUrl: string; tookMs: number; cached: boolean; width: number;
    height: number; size: number; popupsRemoved: number;
  } | null>(null)
        ...
        <div style={{ display: 'flex', flexDirection: 'column', minHeight: 0 }}>
          ...
          <div style={{ flexShrink: 0, borderTop: '1px solid rgba(255,255,255,0.07)', background: '#0a0a0a' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: '1px solid rgba(255,255,255,0.07)', padding: '0 16px' }}>
              ...
              <button onClick={handleCopy} aria-label={copied ? "Copied code" : "Copy code"} style={{ fontFamily: 'var(--font-ibm-plex)', fontSize: 11, color: copied ? '#00e87b' : '#444', background: 'none', border: 'none', cursor: 'pointer', padding: '6px 8px' }}>
                {copied ? 'Copied!' : 'Copy'}
              </button>
            </div>
